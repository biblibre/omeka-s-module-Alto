...
namespace DoctrineProxies\__CG__\Alto\Entity;


/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class AltoDocument extends \Alto\Entity\AltoDocument implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'media', 'xml', 'xmlCompressed', 'created', 'modified'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AltoDocument $proxy) {
    ...
    public function setXmlCompressed(?string $xmlCompressed): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setXmlCompressed', [$xmlCompressed]);

        parent::setXmlCompressed($xmlCompressed);
    }
    ...
    public function getXmlCompressed(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getXmlCompressed', []);

        return parent::getXmlCompressed();
    }
